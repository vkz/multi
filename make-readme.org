...
/Note to Clojure programmers/. Although inspired by Clojure the dispatch semantics of ~mu-defun~ is more expressive. The following is not allowed in Clojure:
