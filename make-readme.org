...
/Note for Clojure programmers/. This implementation takes a lot of inspiration from Clojure, so for the most part Clojure programmers should feel right at home modulo some syntactic differences. Naturally, Emacs Lisp type system is nothing like Clojure let alone Java, so depending on your circumstances your programming patterns may require some adjustment.
